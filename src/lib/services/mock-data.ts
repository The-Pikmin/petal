...
export const mockScanHistory: ScanRecord[] = [
    ...
    },
    {
        ...
        diagnosis: {
            ...
            confidence: 0.88,
            description:
                "A fungal disease causing black spots with yellowing on rose leaves.",
            severity: "medium",
            treatments: [
                {
    ...
    },
    {
        ...
        diagnosis: {
            ...
            confidence: 0.85,
            description:
                "A fungal disease causing white powdery coating on leaves and stems.",
            severity: "medium",
            treatments: [
                {
