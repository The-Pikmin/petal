        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-muted-foreground">
                    {scanHistory.length} scan{scanHistory.length !== 1
                        ? "s"
                        : ""} total
                </p>
            </div>
        ...
        {#if scanHistory.length > 0}
            ...
            <div class="space-y-4">
                {#each scanHistory as scan}
                    <button
                        class="w-full rounded-3xl p-4 text-left transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] bg-card text-card-foreground shadow-sm border border-border"
                    >
